...
#section("Projects")
#project_entry("KaworuOS", "aarch64, kernel, unix-like", "https://github.com/prashantrahul141/KaworuOS", "A WIP hobby arm64 Unix-like operating system with preemptive multitasking and multiprocessor support.")
#section("Skills")
